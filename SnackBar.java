                      ...
                      implements ActionListener
{
  ...
  public SnackBar()
  {
    ...
    Color brandColor1 = new Color(130, 30, 10); // r, g, b... sets the colors of vending machine
    ...
    Box wall = Box.createHorizontalBox(); //creates the 3 separate machines
  ...
  {
    SnackBar window = new SnackBar(); //sets bounds of the window, initializes program (main)
