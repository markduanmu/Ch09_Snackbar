/*
 * 
 * This class creates the GUI of the vending machine
 * 
 */
import java.awt.*; 
                            ...
                            implements ActionListener
{
  ...
  public VendingMachine(String brand, Color color, int price, ImageIcon coin) //constructor class
  {
    setBackground(Color.WHITE); //creates buttons in the vending machine program
    brandColor = color;
    brandName = brand;
  ...
  public void actionPerformed(ActionEvent e) //sets what happens when a certain deposit is made
  {
    ...
    else if (b == go)
    {
      ...
      if (trayFull)          // Successful sale.. returns value back to 0
      {
        repaint();
      ...
      else if (change > 0)   // Refund, gives back change
      {
        JOptionPane.showMessageDialog(null,
          "Take " + change + "c back",
